...
//		Integer[] intArr2 = {1,20,5,9,3,2,7,4,15,9,6};
		...
		System.out.println(Arrays.compare(intArr3, intArr4)); // 1

		// 배열 카피 (2번자 파라미터 갯수 만큼 카피)
		Integer[] intArr5 = Arrays.copyOf(intArr4, 3);
		for (Integer i : intArr5) {
			System.out.print(i + " "); // 1 20 5
		}
		System.out.println();
