...
public class GoogleSMTPTest {
	...
	public static void main(String[] args) {
		...
		String username = "gmldnjs1616@gmail.com"; // 구글 계정명
		String password = "joya gsiy pgda napi"; // 앱 비밀번호

		// SMTP 서버 설정
		Properties props = new Properties(); // key, value 가 문자열인 맵, 설정정보 저장시 자주 사용
		...
		try {
			...
			// 발신자 이메일
			message.setFrom(new InternetAddress("gmldnjs1616@gmail.com"));

			// 수신자 이메일
			message.setRecipients(Message.RecipientType.TO, InternetAddress.parse("gmldnjs1616@gmail.com") //
			);
			...
			// 이메일 내용
			message.setText("안녕 Hi! Google SMTP 서버에서 보낸 이메일임!");
