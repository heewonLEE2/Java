...
/*
	String 은 불변(immutable) : 한번 메모리에 생성된 문자열은 변할 수 없음
	그러므로 문자열 접합 연산을 많이 하면 불필요한 문자열들이 메모리에 많이 생김
	이를 방지하기 위해 자바에서는 StringBuffer와 StringBuilder를 제공함
...
public class StringBuilderTest {
	...
	public static void main(String[] args) {
		...
		System.out.println(sb1.capacity()); // 버퍼의 크기 16 용량이 넘어가지 않으니 그래도 16
		System.out.println(sb1.length()); // 문자의 개수 : 10
		 
		String str1 = sb1.toString(); // 버퍼를 문자열로 변환
