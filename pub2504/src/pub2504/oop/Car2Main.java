...
public class Car2Main {
	...
	public static void main(String[] args) {
		...
		// Car2의 생성자가 private 이라서 객체생성이 Car2 외부에서는 불가능
		// Car2 car2 = new Car2(); // 객체 생성 불가능
...
//		System.out.println(car2_4);
		 
		// setter 메소드를 통해 객체의 멤버변수 값 변경
		Car2 audi = Car2.getInstance();
		audi.setCompany("AUDI KOREA");
		audi.setModel("A8");
		audi.setName("AUDI");
		
		// setter 메소드를 private 로 설정하거나 없애면 외부에서 price  변경 불가
		// audi.setPrice(0);
		// Car2의 getter 가 제공하는 값만 획득 가능
