...
// Component : GUI 를 구성하는 모든 구성요소(Button, TextField, CheckBox...)
// Container : 다른 Component 를 포함할 수 있는 Component (Window, Frame, Panel ...)
...
public class ComponentTest {
	...
	public static void main(String[] args) {
		...
		String[][] data = { // 테이블 2차원 데이터
				{ "1", "홍길동", "20" }, { "2", "강감찬", "30" }, { "3", "이순신", "40" }, };
		String[] columns = { "번호", " 이름", "나이" }; // 컬럼
