...
public class LayoutTest {
	...
	public static void main(String[] args) {
		...
		// FlowLayout : 좌 -> 우, 상 -> 하 : 방향으로, 추가한 순서대로 배치
		// 미설정시 기본 레이아웃
		...
		// BorderLayout : 동/서/남/북/중앙 에 배치, 컴포넌트들이 각 영역을 모두 채움
		...
		/*
		 * GridBagConstraints : 컴포넌트의 위치, 크기, 정렬방식을 제어 gridx, gridy : 컴포넌트가 배치될 격자의 열, 행
		 * gridwidth, gridheight : 컴포넌트가 차지할 열의 수, 행의 수 weightx, weighty : 격자 공간이 남을 때 각
		 * 컴포넌트가 얼마나 공간을 더 가져갈지 fill : 컴포넌트가 셀 내에서 공간을 채우는 방식 GridBagConstraints.NONE :
		 * 크기 고정, 확장하지 않음 (기본값) GridBagConstraints.HORIZONTAL : 가로로만 확장
		 * GridBagConstraints.VERTICAL: 세로로만 확장 GridBagConstraints.BOTH: 가로/세로로만 확장
		 * anchor : 컴포넌트가 셀 내에서 어느 위치에 배치될지 GridBagConstraints.CENTER : 센터
		 * GridBagConstraints.NORTH: 상 GridBagConstraints.SOUTH : 하
		 * GridBagConstraints.EAST : 우 GridBagConstraints.WEST : 좌 insets : 셀내에서 컴포넌트와
		 * 셀테두리간의 여백 ipadx, ipady : 컴포넌트의 x, y 패딩 값
		 */
