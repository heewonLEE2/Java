...
public class Variable1 {
	...
	public static void main(String[] args) {
		...
		float f = 3.14F; // 4바이트 부호화 실수 (1비트가 부호비트, 8비트 지수비트, 23비트 가수비트)
		double d = 2.1; // 8바이트 부호화 실수 (1비트가 부호비트, 11비트 지수비트, 52비트 가수비트)
		char c = 'A'; // 2바이트 유니코드 (문자코드)
		boolean bool = true; // 1바이트 (true, false 의 값만 가짐)
		
		// 정수와 실수는 비트구성이 다르기 때문에 4바이트 실수인 float가 8바이트 정수인 long보다
		// 표현 범위가 더 넓다
		
		// 표현 범위 : double > float > long > int > short > byte
